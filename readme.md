...
I ran this application against jQuery Mobile 1.4.2 minified today and analyzed the execution time using the FireFox performance profiler.  The execution time in Firefox on Windows 10 with 64gb ram and a 6-core Xeon CPU displayed an execution time of 169 milliseconds.  I then ran the benchmarks at http://esprima.org/test/compare.html where Esprima scored the fastest at 169 milliseconds.  As a result this application provides amonge the fastest of all JavaScript parsers written in JavaScript.  Furthermore, since the output is a collection of arrays it should be substantially faster to execute against than the parse tree objects generated by many other parsers.
